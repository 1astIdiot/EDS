...
function CheckForPlugIn_Async() {
    ...
    cadesplugin.async_spawn(function *() {
        ...
        if(location.pathname.indexOf("symalgo_sample.html")>=0){
            ...
            FillCertList_Async('CertListBox', 'CertListBox2');
        }
...
function FillCertList_Async(lstId, secondId) {
    cadesplugin.async_spawn(function *() {
        ...
        second.onchange = onCertificateSelected;
        second.boxId = secondId;
        ...
        if (MyStoreExists) {
            ...
            for (var i = 1; i <= certCnt; i++) {
                ...
                try {
                    ...
                    oOpt2.value = global_selectbox_counter;
...
function CreateSimpleSign_Async() {
    cadesplugin.async_spawn(function*(arg) {
        ...
        try
        {
            ...
            SignatureFieldTitle[0].innerHTML = "Подпись сформирована успешно1a";
        }
        catch(err)
        {
...
function SignCadesBES_Async(certListBoxId, data, setDisplayData) {
    cadesplugin.async_spawn(function*(arg) {
        ...
        try
        {
            ...
            document.getElementById("SignatureTxtBox").innerHTML = Signature;
            SignatureFieldTitle[0].innerHTML = "Подпись сформирована успешно 2a";
        }
        catch(err)
        {
    ...
    cadesplugin.async_spawn(function*(arg) {
        ...
        try
        {
            ...
            for (var i = 0; i < fileContent.length; i++) {
                // var dataToSign = fileContent[i]; // fileContent - объявлен в Code.js
                ...
                tmpPromise.then(() => {
                    if (certListBoxId === "CertListBox") {
                        ...
                        if (dSignedFilesNumber === fileContent.length) {
                            div.id = 'documents-list-doctor-sign-success';
                            ...
                            document.getElementById('documents-list-doctor-sign-success').innerHTML = 'Подписи доктора успешно сохранены';
                    ...
                    if (certListBoxId === "CertListBox2") {
                        ...
                        if (oSignedFilesNumber === fileContent.length) {
                            div2.id = 'documents-list-organization-sign-success';

                            document.getElementById('documents-list-text-container').appendChild(div2);
                            document.getElementById('documents-list-organization-sign-success').innerHTML = 'Подписи от организации успешно сохранены';
                        }
...
function SignCadesEnhanced_Async(certListBoxId, sign_type) {
    cadesplugin.async_spawn(function*(arg) {
        ...
        try
        {
            ...
            document.getElementById("SignatureTxtBox").innerHTML = Signature;
            SignatureFieldTitle[0].innerHTML = "Подпись сформирована успешно 4a";
        }
        catch(err)
        {
            SignatureFieldTitle[0].innerHTML = "Возникла ошибка:";
...
function SignCadesXML_Async(certListBoxId, signatureType) {
    cadesplugin.async_spawn(function*(arg) {
        ...
        try
        {
            ...
            document.getElementById("SignatureTxtBox").innerHTML = Signature;
            SignatureFieldTitle[0].innerHTML = "Подпись сформирована успешно 5a";
        }
        catch(err)
        {
            SignatureFieldTitle[0].innerHTML = "Возникла ошибка:";
...
function verifyCert_Async() {
    ...
    createSignature_Async().then(
        function(signedMessage){
            ...
            x[0].innerHTML = "Подпись сформирована успешно 6a";
            removeWaitMessage();
        },
        function(signedMessage){
            removeWaitMessage();
